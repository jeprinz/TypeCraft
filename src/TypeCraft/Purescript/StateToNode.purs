...
stateToNode st = case st.mode of
  CursorMode cursor -> case cursor.cursorLocation of
    ...
    TypeBindCursor ctxs upPath tyBnd -> hole
    TermBindCursor ctxs upPath tmBnd -> hole
    TypeArgListCursor ctxs upPath tyArg -> hole
    CtrListCursor ctxs upPath ctr -> hole
    CtrParamListCursor ctxs upPath ctrPrm -> hole
    TypeBindListCursor ctxs upPath tyBnds -> hole
