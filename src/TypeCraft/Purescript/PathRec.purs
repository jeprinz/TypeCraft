...
recTermPath args {kctx, ctx, ty} (Let1 md bind@(TermBind _ x) tBinds defTy body bodyTy) =
    ...
    args.let1 {kctx, ctx: delete x ctx, ty: bodyTy} md bind tBinds
        ...
        bodyTy -- bodyTy
recTermPath args {kctx, ctx, ty} (Let3 md bind@(TermBind _ x) tBinds def defTy bodyTy) =
