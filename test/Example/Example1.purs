...
example2 :: Term /\ Type
example2 =
  (Let { bodyIndented: true, defIndented: false, typeIndented: false, varIndented: false } (TermBind { varName: "" } (fromJust $ UUID.parseUUID "10a74b7c-3df3-4e3b-b4ad-b1604a75000b")) Nil (Hole {}) (THole {} (fromJust $ UUID.parseUUID "02355002-f3fd-4e8c-94bd-0a7aaef884a0") (Set.fromFoldable []) (Map.fromFoldable [])) (Hole {}) (THole {} (fromJust $ UUID.parseUUID "104261b2-a21e-45f4-bc86-c51e27c856f6") (Set.fromFoldable []) (Map.fromFoldable [])))
    /\ (THole {} (fromJust $ UUID.parseUUID "104261b2-a21e-45f4-bc86-c51e27c856f6") (Set.fromFoldable []) (Map.fromFoldable []))
